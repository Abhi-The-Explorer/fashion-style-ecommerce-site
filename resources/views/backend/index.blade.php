...
<div class="page-wrapper">
        ...
        <!-- <nav>
    <div class="navbar">
    <img src="{{ asset('storage/' . $siteSettings['logo']->value) }}" alt="Logo">

        <div>
            <h4>{{ $siteSettings['slogan']->value ?? 'Your Slogan Here' }}</h4>
            <p>Contact: {{ $siteSettings['mobile_no']->value ?? 'No contact number available' }}</p>
        </div>
    </div>
</nav> -->
